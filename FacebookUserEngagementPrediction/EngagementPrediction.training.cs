...
namespace FacebookUserEngagementPrediction
{
    public partial class EngagementPrediction
    {
        public const string RetrainFilePath =  @"E:\Projects\ML NET\FacebookUserEngagementPrediction\FacebookUserEngagementPrediction\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=26,MinimumExampleCountPerLeaf=5,NumberOfTrees=12,MaximumBinCountPerFeature=365,FeatureFraction=0.811864182476437,LearningRate=0.960327759353343,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
